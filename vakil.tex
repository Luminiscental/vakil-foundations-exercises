...
\begin{enumerate}[label=\textbf{6.6.\Alph*.}]
	...
	\item The functor in question is $X\mapsto\{u\in U(\Gamma(X)):u^n=1\}$.
	      ...
	      characteristic $p$ dividing $n$ we have $t^n-1=(t-1)^n$, so $t-1$
	      gives a non-trivial nilpotent function on this group scheme.
	...
	\item We have a contravariant functor $\cat{Sch}_A\to\cat{CRing}$ by
	      ...
	      \begin{equation*}
		      \begin{tikzcd}
			      &\id\in\Mor(\A^1_A\times\A^1_A) \ar[d,equal]
