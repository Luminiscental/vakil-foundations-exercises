...
\begin{enumerate}[label=\textbf{8.2.\Alph*.}]
	\item
	      \begin{enumerate}[label=(\alph*)]
		      ...
		      \item From 3.6.F the map
		            ...
		            $w\mapsto b^3$, $x\mapsto ab^2$, $y\mapsto a^2b$, $z\mapsto a^3$
		            is an isomorphism. Since this is a graded map, it induces an
		            isomorphism
		            $\Proj k[w,x,y,z]/(wz-xy,x^2-wy,y^2-xz)\cong\Proj k[a,b]$.
	      \end{enumerate}
	...
	\item From 3.6.F the map descends to
	      $k[w,x,y,z]/(wz-xy,x^2-wy,y^2-xz)\cong k[s,t]$, so $\P^1_k\to\P^3_k$
	      factors as $\P^1_k\cong V(wz-xy,x^2-wy,y^2-xz)\hookrightarrow\P^3_k$.
